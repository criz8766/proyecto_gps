...
# Cargar variables de entorno desde .env ubicado en la raíz del microservicio 'informes'
...
def require_permission(required_permission: str):
    """
    Decorador para validar permisos específicos en el token.
    """

    def _require_permission(payload: dict):
